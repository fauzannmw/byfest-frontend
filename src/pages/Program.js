        ...
        <div className="container">
          ...
          <div className="program">
            ...
            <Row xs={1} md={1} className="g-4">
              {dataFilm.filter(filterfilm => filterfilm.jenis === "FK1").map((posterFilm) => (
      ...
      <div className="content">
        <div className="container">
          ...
          <div className="program">
            ...
            <Row xs={1} md={1} className="g-4">
              {dataFilm.filter(filterfilm => filterfilm.jenis === "FK2").map((posterFilm) => (
                <Col xs={12} md={6} lg={4} className="column">
                  <div className="poster-wrapper">
                    <img
                      src={`/img/programs/${posterFilm.poster}`}
      ...
      <div className="content">
        <div className="container">
          ...
          <div className="program">
            ...
            <Row xs={1} md={1} className="g-4">
              {dataFilm.filter(filterfilm => filterfilm.jenis === "DK").map((posterFilm) => (
                <Col xs={12} md={6} lg={4} className="column">
                  <div className="poster-wrapper">
                    <img
                      src={`/img/programs/${posterFilm.poster}`}
      ...
      <div className="content">
        <div className="container">
          ...
          <div className="program">
            ...
            <Row xs={1} md={1} className="g-4">
              {dataFilm.filter(filterfilm => filterfilm.jenis === "NK").map((posterFilm) => (
                <Col xs={12} md={6} lg={4} className="column">
                  <div className="poster-wrapper">
                    <img
                      src={`/img/programs/${posterFilm.poster}`}
