      ...
      <div className="content">
        <div className="container">
          ...
          <div className="program">
            ...
            <p className="deskripsi">Uang: alat tukar atau standar pengukur nilai (kesatuan hitungan) yang sah, dikeluarkan oleh pemerintah 
              suatu negara berupa kertas, emas, perak, atau logam lain yang dicetak dengan bentuk dan gambar tertentu; 
              2 n harta; kekayaan: hidupnya seolah-olah hanya mencari --; <br />
              Uang merupakan kebutuhan pokok yang paling utama bagi manusia, namun uang juga merupakan faktor paling utama 
              dalam membuka tabir gelap manusia; keserakahan, kerakusan, ketamakan, dan segala sifat buruk yang ada dunia. 
              Segala cara dan jalan menjadi halal jika uang tujuan utamanya. <br />
              “Uang” merupakan salah satu tajuk program pada BYFEST tahun ini. Dalam program ini kami akan menampilkan empat 
              film yang berkaitan erat dengan uang dan segala keburukannya dalam pengemasan yang berbeda-beda. Ada komedi, eksperimental, 
              dan juga drama. Diharapkan dengan kehadiran program ini dapat membuka ruang diskusi tentang bagaimana realitas kehidupan 
              yang dengan mudah disetir oleh kebutuhan pokok manusia yang satu ini</p>
