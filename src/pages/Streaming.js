...
const Streaming = () => {
  ...
  const films = [
    //DAY 1
    // day 1 Program Film Pendek D & Program Film Panjang 1 (Violetta)
    {
      day: "1",
    ...
    //DAY-2
    //Program Film Pendek K1 & Program Film Pendek K2
    {
      day: "2",
    ...
    //DAY 3
    //Program Film Pendek Non Kompetitif & Program Film Panjang 2 (Senyum Pagi)
    {
      day: "3",
      judul: "Facade",
  ...
  return (
    <div className="container">
      ...
      <Youtube />
      {films.filter(filterfilm => filterfilm.day === slug).map((film) => {
        return (
